<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="faltas.php"><i class="fa fa-suitcase"></i> Faltas</a></li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-users"></i>
            <span>Reportes</span>
          ...
          <ul class="treeview-menu">
            <li><a href="attendance1.php"><i class="fa fa-circle-o"></i> De asistencia por mes</a></li>
            <!-- <li><a href="overtime.php"><i class="fa fa-circle-o"></i> A través del tiempo</a></li>
            <li><a href="cashadvance.php"><i class="fa fa-circle-o"></i> Adelanto en efectivo</a></li> -->
            <li><a href="attendance2.php"><i class="fa fa-circle-o"></i> Día específico</a></li>
            <li><a href="attendance5.php"><i class="fa fa-circle-o"></i> Faltas</a></li>
          </ul>
        </li>
